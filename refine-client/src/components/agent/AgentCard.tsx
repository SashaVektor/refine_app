...
const InfoBar = ({ icon, name }: InfoBarProps) => (
  <Stack flex={1} minWidth={{xs: "100%", sm: "300px"}} gap={1.5} direction="row">
    {icon}
  ...
  return (
    <Box
      ...
      sx={{
        ...
        "&.hover": {
          boxShadow: "0 22px 45px 2px rgba(176,176,176, .1)"
        }
      }}
    >
      <img src={avatar} alt={name} width={90} height={90} style={{
